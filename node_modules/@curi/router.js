  ...
  function createRouter(history, routeArray, options) {
      ...
      function createFinisher(pending, response, navigation) {
          ...
          return function finisher() {
              ...
              activeNavigation = undefined;
              callOneTimersAndSideEffects({ response: response, navigation: navigation, router: router });
          };
      }
      ...
      function callOneTimersAndSideEffects(emitted) {
          oneTimers.splice(0).concat(sideEffects).forEach(function (fn) {
              fn(emitted);
          });
      }
      function emitImmediate(response, navigation) {
          ...
          if (!response.redirectTo || emitRedirects) {
              ...
              callObservers({ response: response, navigation: navigation, router: router });
              callOneTimersAndSideEffects({ response: response, navigation: navigation, router: router });
          }
