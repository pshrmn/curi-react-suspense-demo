(function(global, factory) {
  ...
  ***************************************************************************** */
  ...
  function createRedirect(redirectTo, interactions) {
    var name = redirectTo.name,
      params = redirectTo.params,
      rest = __rest(redirectTo, ["name", "params"]);
  ...
  function finishResponse(routeMatch, interactions, resolvedResults) {
    ...
    var _a = resolvedResults || {},
      _b = _a.resolved,
      resolved = _b === void 0 ? null : _b,
      _c = _a.error,
  ...
  function matchRoute(route, pathname) {
    ...
    var matchedSegment = regExpMatch[0],
      parsed = regExpMatch.slice(1);
    var params = {};
  ...
  function resolveRoute(match) {
    var asyncFns = match.route.public.match;
    var _a = Object.keys(asyncFns).reduce(
        function(acc, key) {
          acc.keys.push(key);
    ...
    return Promise.all(promises).then(
      ...
      function(error) {
        return { error: error, resolved: null };
      }
    );
  }
  ...
  function createRouter(history, routeArray, options) {
    ...
    var _a = options.route,
      userInteractions = _a === void 0 ? [] : _a,
      _b = options.sideEffects,
      sideEffects = _b === void 0 ? [] : _b,
      _c = options.emitRedirects,
      emitRedirects = _c === void 0 ? true : _c,
      _d = options.suspend,
      suspend = _d === void 0 ? false : _d;
    var routes = [];
    ...
    var router = {
      ...
      history: history,
      respond: function(fn, options) {
        var _a = options || {},
          _b = _a.observe,
          observe = _b === void 0 ? false : _b,
          _c = _a.initial,
          initial = _c === void 0 ? true : _c;
        if (observe) {
          observers.push(fn);
